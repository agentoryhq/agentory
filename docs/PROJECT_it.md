# Agentory — Documento di Contesto Progetto
...
**Agentory** è una piattaforma AI multi-utente che permette di collegare tool HTTP custom, query SQL, tool RAG su
