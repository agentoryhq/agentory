...
```
Crea una skill per Agentory che [descrizione funzionalità].
...
```
Crea una skill per Agentory con più script: [script_1.py, script_2.py, ...].
...
```
Crea una skill per Agentory che [descrizione funzionalità] e include un daemon
