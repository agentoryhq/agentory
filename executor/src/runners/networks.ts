 ...
 *   internal  backend baseline only (agentory-internal, internal:true → no route to the WAN).
...
const INTERNAL_NET = process.env.JOB_INTERNAL_NETWORK || 'agentory-internal';
